...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Symmetric difference of Set1: " + difference(set1, set2));
        System.out.println("Symmetric difference of Set2: " + difference2(set1,set2));
    ...
    public static <Integer> Set<Integer> difference2(Set<Integer> set1, Set<Integer> set2) {
